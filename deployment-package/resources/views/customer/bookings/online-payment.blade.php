            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="text-center mb-6">
                        ...
                        <h2 class="mt-2 text-2xl font-bold text-gray-900">Online Payment</h2>
                        <p class="mt-1 text-gray-500">Make a secure payment for your booking</p>
                    </div>
                    ...
                    <div class="max-w-md mx-auto">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-yellow-800">
                                        This is a placeholder for the payment gateway integration. In a production environment, you would be redirected to a secure payment page.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-6 mb-6">
                            ...
                            <dl class="space-y-2">
                                ...
                                <div class="flex justify-between">
                                    <dt class="text-sm text-gray-600">Activity</dt>
                                ...
                                <div class="border-t border-gray-200 pt-2 mt-2">
                                    <div class="flex justify-between font-medium">
                                        <dt class="text-base text-gray-900">Total Amount</dt>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="name_on_card" name="name_on_card" placeholder="John Doe" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500">
                            </div>
                        </div>
