            ...
            <div id="receipt" class="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200 print:shadow-none print:border-2">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-8 print:bg-blue-600">
                    <div class="flex items-center justify-between text-white">
                        <div>
                            ...
                            <p class="text-sm opacity-90">Outdoor Activity Booking Platform</p>
                        </div>
                        <div class="text-right">
                            <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl px-6 py-3">
                                <p class="text-xs font-semibold uppercase tracking-wide opacity-90">Receipt</p>
                ...
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 pb-8 border-b-2 border-gray-200">
                        <!-- Bill To -->
                        <div>
                            <h3 class="text-sm font-bold text-gray-500 uppercase tracking-wide mb-3">Bill To:</h3>
                        ...
                        <div class="text-left md:text-right">
                            <h3 class="text-sm font-bold text-gray-500 uppercase tracking-wide mb-3">Receipt Details:</h3>
                            <div class="space-y-1">
                                <p class="text-sm text-gray-600">
                                    <span class="font-semibold">Receipt Date:</span> {{ now()->format('M d, Y') }}
                                </p>
                                <p class="text-sm text-gray-600">
                                    <span class="font-semibold">Booking Ref:</span> {{ $booking->booking_reference }}
                                </p>
                                <p class="text-sm text-gray-600">
                                    <span class="font-semibold">Transaction ID:</span> {{ $booking->billplz_transaction_id ?? 'N/A' }}
                                </p>
                                <p class="text-sm text-gray-600">
                                    <span class="font-semibold">Payment Date:</span> {{ $booking->billplz_paid_at ? $booking->billplz_paid_at->format('M d, Y h:i A') : 'N/A' }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="bg-blue-50 rounded-xl p-6 border border-blue-100">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide mb-1">Date</p>
                                    <p class="text-sm font-bold text-gray-900">{{ $booking->booking_date->format('M d, Y') }}</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide mb-1">Time</p>
                                    <p class="text-sm font-bold text-gray-900">{{ $booking->start_time->format('h:i A') }}</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide mb-1">Participants</p>
                                    <p class="text-sm font-bold text-gray-900">{{ $booking->participants }} {{ Str::plural('Person', $booking->participants) }}</p>
                                </div>
                            </div>
                        ...
                        <div class="bg-gray-50 rounded-xl overflow-hidden border border-gray-200">
                            <table class="w-full">
                                ...
                                <tfoot class="bg-gray-100">
                                    <tr>
                                        <td colspan="3" class="px-6 py-4 text-right text-sm font-bold text-gray-900 uppercase">Total Paid:</td>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide mb-1">Payment Status</p>
                                <p class="text-sm font-bold text-green-600">PAID</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-yellow-50 border-l-4 border-yellow-500 rounded-xl p-6">
                        ...
                        <ul class="space-y-2 text-xs text-yellow-800">
                            ...
                            <li class="flex items-start">
                                ...
                                Bring this receipt or your booking reference number
                            </li>
                            <li class="flex items-start">
                                <svg class="w-4 h-4 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            ...
                            <li class="flex items-start">
                                ...
                                This receipt is valid proof of payment and booking confirmation
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="bg-gray-100 px-8 py-6 border-t-2 border-gray-200">
                    <div class="text-center text-sm text-gray-600">
                        <p class="font-semibold mb-2">Thank you for choosing OFYS!</p>
                        <p class="text-xs">For support, contact us at <strong>support@ofys.com</strong> or call <strong>+60 12-345-6789</strong></p>
                        <p class="text-xs mt-2 text-gray-500">This is a computer-generated receipt and does not require a signature.</p>
                    </div>
                </div>
            </div>
