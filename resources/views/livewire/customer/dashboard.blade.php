                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="border-b border-gray-200 mb-6">
                        <nav class="-mb-px flex space-x-8">
                            ...
                            <button wire:click="setActiveTab('account')" class="{{$activeTab === 'account' ? 'border-yellow-500 text-yellow-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                                Account
                            </button>
                            ...
                            <div>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div class="flex items-center">
                                                                <div class="h-10 w-10 flex-shrink-0">
                                                                    <img class="h-10 w-10 rounded-full object-cover" src="{{ $booking->activity_image ?? 'https://via.placeholder.com/40' }}" alt="">
                                                                </div>
                                                                <div class="ml-4">
                                                                    <div class="text-sm font-medium text-gray-900">{{ $booking->activity_name ?? 'Activity Name' }}</div>
                                                                    <div class="text-sm text-gray-500">{{ $booking->location ?? 'Location' }}</div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div class="text-sm text-gray-900">{{ $booking->date ?? '2023-06-15' }}</div>
                                                            <div class="text-sm text-gray-500">{{ $booking->time ?? '9:00 AM' }}</div>
                                                        </td>
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div class="text-sm text-gray-900">{{ $booking->provider_name ?? 'Provider Name' }}</div>
                                                        </td>
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @else
                                    <div class="text-center py-12">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">Get started by booking an outdoor activity.</p>
                                        <div class="mt-6">
                                            <a href="#" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500">
                                                Browse Activities
                                            </a>
