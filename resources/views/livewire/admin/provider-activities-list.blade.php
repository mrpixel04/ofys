                            ...
                            <tr>
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            @if(isset($activity->images[0]))
                                                <img class="h-10 w-10 rounded-md object-cover" src="{{ $activity->images[0] }}" alt="{{ $activity->name }}">
                                            @else
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <button wire:click="viewActivity({{ $activity->id }})" class="text-blue-600 hover:text-blue-900 border border-blue-600 rounded px-2 py-1 transition duration-150 ease-in-out">
                                            View
                                        </button>
                                    </div>
                                </td>
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex-shrink-0 h-10 w-10">
                                    @if(isset($viewingActivity->images[0]))
                                        <img class="h-10 w-10 rounded-md object-cover" src="{{ $viewingActivity->images[0] }}" alt="{{ $viewingActivity->name }}">
                                    @else
                                        <div class="h-10 w-10 rounded-md bg-blue-100 flex items-center justify-center">
                                            <svg class="h-6 w-6 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
