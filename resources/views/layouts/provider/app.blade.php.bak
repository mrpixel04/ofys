    ...
    <div class="min-h-screen">
        ...
        <div x-data="{ open: false }" class="md:hidden">
            <div class="bg-gradient-to-r from-teal-500 to-emerald-600 px-4 py-3 flex items-center justify-between">
                ...
                <div>
                    <button @click="open = !open" type="button" class="p-2 rounded-md inline-flex items-center justify-center text-white hover:bg-teal-600 focus:outline-none">
            ...
            <!-- Mobile menu panel -->
            <div x-show="open" x-cloak class="bg-teal-50 border-b border-teal-200">
