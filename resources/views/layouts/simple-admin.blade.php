        ...
        <div id="sidebar" class="sidebar fixed inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-purple-800 to-purple-900 text-white lg:translate-x-0 lg:static lg:inset-0 shadow-xl">
            ...
            <nav class="mt-5 px-2 space-y-1">
                ...
                <div class="dropdown-menu">
                    ...
                    <div class="submenu pl-4 pr-2 mt-2 space-y-1 rounded-md {{ request()->routeIs('admin.developers*') || request()->routeIs('admin.whatsapp*') ? 'active' : '' }}">
                        <a href="{{ route('admin.developers.api') ?? '#' }}" class="flex items-center py-2 px-4 text-white hover:bg-purple-600/50 rounded-md transition-all duration-200 {{ request()->routeIs('admin.developers.api') ? 'menu-active' : '' }}">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                            {{ __('API Documentation') }}
                        </a>
                        <a href="{{ route('admin.developers.integration') ?? '#' }}" class="flex items-center py-2 px-4 text-white hover:bg-purple-600/50 rounded-md transition-all duration-200 {{ request()->routeIs('admin.developers.integration') ? 'menu-active' : '' }}">
                        ...
                        <a href="{{ route('admin.whatsapp.messages') ?? '#' }}" class="flex items-center py-2 px-4 text-white hover:bg-purple-600/50 rounded-md transition-all duration-200 {{ request()->routeIs('admin.whatsapp.messages') ? 'menu-active' : '' }}">
