    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1">
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-gray-300 hover:text-white">Camping</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white">Hiking</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white">Kayaking</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white">ATV Riding</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white">Rock Climbing</a></li>
                </ul>
            </div>
            ...
            <div class="col-span-1">
                ...
                <p class="text-gray-300 mb-4">Stay updated with our latest adventures and promotions.</p>
                <form class="flex flex-col sm:flex-row gap-2">
                    <input type="email" placeholder="Your email" class="px-4 py-2 rounded-md text-gray-900 focus:ring-yellow-500 focus:border-yellow-500">
