<x-admin-layout>
    <div class="container mx-auto px-4 py-6">
                    ...
                    <div class="bg-white p-4 rounded-lg border border-gray-200 hover:shadow-md transition-all">
                        ...
                        <form>
                            <div class="mb-4">
                                ...
                                <input type="number" step="0.01" min="0" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 py-3 px-4 text-base" value="{{ $booking->total_price }}">
                            </div>
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Receipt Image</label>
                                <input type="file" class="w-full text-sm text-gray-500 file:mr-4 file:py-3 file:px-4 file:border-0 file:rounded-md file:text-sm file:font-medium file:bg-purple-50 file:text-purple-700 hover:file:bg-purple-100 py-2">
                            </div>
                            <button type="button" class="w-full bg-purple-600 hover:bg-purple-700 text-white font-medium py-3 px-6 rounded-md transition-colors text-base">
                                Confirm Payment
                            </button>
                        </form>
                    </div>
                    ...
                    <div class="bg-white p-4 rounded-lg border border-gray-200 hover:shadow-md transition-all">
                        ...
                        <form>
                            <div class="mb-4">
                                ...
                                <input type="number" step="0.01" min="0" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 py-3 px-4 text-base" value="{{ $booking->total_price }}">
                            </div>
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Notes</label>
                                <textarea class="w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 py-3 px-4 text-base" rows="2" placeholder="Any payment notes"></textarea>
                            </div>
                            <button type="button" class="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-6 rounded-md transition-colors text-base">
                                Record Cash Payment
                            </button>
                        </form>
                    </div>
                    ...
                    <div class="bg-white p-4 rounded-lg border border-gray-200 hover:shadow-md transition-all">
                        ...
                        <form>
                            <div class="mb-4">
                                ...
                                <input type="text" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 py-3 px-4 text-base" placeholder="e.g. Toyyibpay">
                            </div>
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Transaction ID</label>
                                <input type="text" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 py-3 px-4 text-base" placeholder="e.g. TYP12345678">
                            </div>
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Amount Paid (RM)</label>
                                <input type="number" step="0.01" min="0" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 py-3 px-4 text-base" value="{{ $booking->total_price }}">
                            </div>
                            <button type="button" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-md transition-colors text-base">
        ...
        <div class="mt-6 flex flex-wrap justify-end space-x-4">
            <a href="{{ route('admin.bookings.edit', $booking->id) }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-6 rounded-md transition-colors text-base">
                Edit Booking
            </a>

            @if(strtoupper($booking->status) != 'CANCELLED')
                <button type="button" class="bg-red-600 hover:bg-red-700 text-white font-medium py-3 px-6 rounded-md transition-colors text-base">
                    Cancel Booking
                </button>
            @endif
        </div>
