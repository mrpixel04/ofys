...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    ...
    <form action="{{ route('admin.providers.activities.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Select the provider who will own this activity</p>
                </div>
                ...
                <div>
                    ...
                    <select name="state" id="state" required
                        ...
                        @foreach($malaysianStates as $value => $label)
                            <option value="{{ $value }}" {{ old('state') == $value ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="min_participants" id="min_participants" min="1" value="{{ old('min_participants', 1) }}" required
                        class="block w-full h-10 px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="duration_minutes" id="duration_minutes" min="0" value="{{ old('duration_minutes') }}"
                        class="block w-full h-10 px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200">
            ...
            <div class="mb-6">
                ...
                <textarea name="description" id="description" rows="5" required
                    class="block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm">{{ old('description') }}</textarea>
            ...
            <div class="mb-6">
                ...
                <textarea name="requirements" id="requirements" rows="3"
                    class="block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm">{{ old('requirements') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div id="amenities-container" class="space-y-2">
                        @if(old('amenities'))
                            @foreach(old('amenities') as $index => $item)
                                <div class="flex items-center space-x-2">
                ...
                <div>
                    ...
                    <div id="rules-container" class="space-y-2">
                        @if(old('rules'))
                            @foreach(old('rules') as $index => $item)
                                <div class="flex items-center space-x-2">
            ...
            <div class="mt-6">
                ...
                <textarea name="cancelation_policy" id="cancelation_policy" rows="3"
                    class="block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm">{{ old('cancelation_policy') }}</textarea>
            </div>
        </div>
        ...
        <div id="lots-section" class="bg-white p-6 rounded-lg shadow-md border border-gray-200 {{ !in_array(old('activity_type'), ['camping', 'glamping']) ? 'hidden' : '' }}">
            <h2 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
        ...
        <div class="flex items-center justify-end space-x-4">
            <a href="{{ route('admin.providers.activities') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                Cancel
            </a>
